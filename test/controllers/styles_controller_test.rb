...
class StylesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create style" do
    assert_difference("Style.count") do
      post styles_url, params: { style: { fill_id: @style.fill_id, opacity: @style.opacity, stroke_id: @style.stroke_id } }
    end
  ...
  test "should update style" do
    patch style_url(@style), params: { style: { fill_id: @style.fill_id, opacity: @style.opacity, stroke_id: @style.stroke_id } }
